...
/** Stop manual driving if fresh app-control packets stop arriving */
#define APP_CONTROL_TIMEOUT 500
...
void loop() {
  ...
  if (currentMode == MODE_APP_CONTROL && millis() - lastAppControlTime > APP_CONTROL_TIMEOUT) {
    leftMotorPower = 0;
    rightMotorPower = 0;
